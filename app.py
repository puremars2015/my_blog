...
def read_article(id):
    ...
    return render_template('read_article.html', title=article[0]["title"], page=article[0]["page"], img_url= request.url_root + 'api/images/' + article[0].get("img_url", "") if article[0].get("img_url") else request.url_root + "static/B0B0B0.png")
